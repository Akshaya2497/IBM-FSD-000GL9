package comm.example.container;
...
public class AddLeagueController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		if(errMsgs.isEmpty())
		{
			...
			Connection connection=MyConnectionFactory.getMySqlConnectionForLeague();
			PreparedStatement pst=connection.prepareStatement("insert into leagues(title,season,year,uid) values(?,?,?,?)");
